...
import {
    ...
    NkCheckboxOption,
    ValueFormat
} from '../../../../ngx-uikit/src/components/core/type/nk-types';
...
export class DemoCheckboxComponent implements OnInit {
    ...
    singleString = '单字符串';
    singleNumber = 123;
    objectOptions: NkCheckboxOption[] = [{nkLabel: '语文', nkValue: 1}, {nkLabel: '数学', nkValue: 2}, {
        nkLabel: '英语',
        nkValue: 3
    }];
    ...
    anyObjectOptions: NkCheckboxOption[] = [{name: '高级', code: 'hight', sss: 'ddd'}, {
        name: '中级',
        code: 'middle'
    }, {name: '初级', code: 'normal'}];
