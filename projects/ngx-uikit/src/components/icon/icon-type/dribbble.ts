...
export const NkIconDribbble: NkIcon = {
  name: 'dribbble',
  viewBox: '0 0 20 20',
  icon: `<path fill="none" stroke="#000" stroke-width="1.4" d="M1.3,8.9c0,0,5,0.1,8.6-1c1.4-0.4,2.6-0.9,4-1.9 c1.4-1.1,2.5-2.5,2.5-2.5" />
